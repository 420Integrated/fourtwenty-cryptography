...
developing Javascript/TypeScript applications and tools for 420coin.
...
```bash
$ npm install fourtwenty-cryptography
```

Via `yarn`:

```bash
$ yarn add fourtwenty-cryptography
```
...
```js
const { getRandomBytesSync } = require("fourtwenty-cryptography/random");
...
```js
const { keccak256 } = require("fourtwenty-cryptography/keccak");
...
```js
const { scryptSync } = require("fourtwenty-cryptography/scrypt");
...
normally used with `pbkdf2` in 420coin. It may support more.
...
```js
const { pbkdf2Sync } = require("fourtwenty-cryptography/pbkdf2");
...
```js
const { sha256 } = require("fourtwenty-cryptography/sha256");
...
```js
const { ripemd160 } = require("fourtwenty-cryptography/ripemd160");
...
```js
const { blake2b } = require("fourtwenty-cryptography/blake2b");
...
```js
const { encrypt } = require("fourtwenty-cryptography/aes");
...
```js
const { createPrivateKeySync, ecdsaSign } = require("fourtwenty-cryptography/secp256k1");
...
```js
const { HDKey } = require("fourtwenty-cryptography/hdkey");
...
* `fourtwenty-cryptography/bip39/wordlists/czech.js`

* `fourtwenty-cryptography/bip39/wordlists/english.js`

* `fourtwenty-cryptography/bip39/wordlists/french.js`

* `fourtwenty-cryptography/bip39/wordlists/italian.js`

* `fourtwenty-cryptography/bip39/wordlists/japanese.js`

* `fourtwenty-cryptography/bip39/wordlists/korean.js`

* `fourtwenty-cryptography/bip39/wordlists/simplified-chinese.js`

* `fourtwenty-cryptography/bip39/wordlists/spanish.js`

* `fourtwenty-cryptography/bip39/wordlists/traditional-chinese.js`

### Example usage

```js

const { generateMnemonic } = require("fourtwenty-cryptography/bip39");
const { wordlist } = require("fourtwenty-cryptography/bip39/wordlists/english");
...
`fourtwenty-cryptography` is released under [the MIT License](./LICENSE).

[1]: https://img.shields.io/npm/v/fourtwenty-cryptography.svg
[2]: https://www.npmjs.com/package/fourtwenty-cryptography
[3]: https://img.shields.io/travis/420integrated/fourtwenty-cryptography/master.svg?label=Travis%20CI
[4]: https://travis-ci.org/420integrated/fourtwenty-cryptography
[5]: https://img.shields.io/npm/l/fourtwenty-cryptography
[6]: https://github.com/420integrated/fourtwenty-cryptography/blob/master/packages/fourtwenty-cryptography/LICENSE
[7]: https://img.shields.io/npm/types/fourtwenty-cryptography.svg
[8]: https://www.npmjs.com/package/fourtwenty-cryptography
