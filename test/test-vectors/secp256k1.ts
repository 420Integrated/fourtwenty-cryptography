...
export function createTests(
  ...
  describe("secp256k1", function() {
    ...
    it("Should sign correctly", function() {
      // This test has been adapted from fourtwentyjs-util
      // https://github.com/fourtwentyjs/fourtwentyjs-util/blob/3b1085059194b02354177d334f89cd82a5187883/test/index.js#L531
